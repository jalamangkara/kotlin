...
/**
 * Compiler options for Kotlin JVM platform.
 */
interface KotlinJvmOptions : org.jetbrains.kotlin.gradle.dsl.KotlinCommonOptions {
    ...
    /**
     * Generates metadata for Java 1.8 reflection on method parameters
     *
     * Default value: `false`
     */
    ...
    /**
     * The name of the generated `.kotlin_module` file
     *
     * Default value: `null`
     */
    ...
    /**
     * Disables automatically including the Java runtime into the classpath
     *
     * Default value: `false`
     */
