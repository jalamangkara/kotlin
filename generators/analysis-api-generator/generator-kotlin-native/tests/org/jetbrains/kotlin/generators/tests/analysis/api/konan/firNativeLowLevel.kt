...
import org.jetbrains.kotlin.analysis.low.level.api.fir.konan.compiler.based.AbstractCompilerBasedNativeTestForFir
...
internal fun TestGroupSuite.generateFirNativeLowLevelTests() {
    testGroup("analysis/low-level-api-fir/kotlin-native/tests-gen", "compiler/testData/diagnostics") {
        testClass<AbstractCompilerBasedNativeTestForFir>(
