        ...
        private fun registerApplicationExtensionPointsAndExtensionsFrom(configuration: CompilerConfiguration, configFilePath: String) {
            ...
            val pluginRoot: File =
                configuration.get(CLIConfigurationKeys.INTELLIJ_PLUGIN_ROOT)?.let(::File)
                    ...
                    // hack for load extensions when compiler run for tests
                    ?: PathUtil.getResourcePathForClass(this::class.java).parentFile.parentFile.parentFile.parentFile.resolve("cli-common/resources").takeIf { it.hasConfigFile(configFilePath) }
