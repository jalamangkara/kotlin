...
class K2JSCompilerArguments : CommonCompilerArguments() {
    ...
    @Argument(value = "-output", valueDescription = "<filepath>", description = "The destination `*.js` file for the compilation result")
    ...
    @Argument(value = "-ir-output-name", description = "The base name of generated files")
    ...
    @Argument(
        value = "-no-stdlib",
        description = "Disables automatically including the default Kotlin/JS stdlib in compilation dependencies"
    )
    var noStdlib = false
        set(value) {
            checkFrozen()
    ...
    @Argument(value = "-source-map", description = "Generates the source map")
    var sourceMap = false
        set(value) {
            checkFrozen()
            field = value
    ...
    @Argument(value = "-source-map-prefix", description = "Adds the specified prefix to paths in the source map")
    ...
    @Argument(
            ...
            description = "Embeds source files into the source map"
    )
    ...
    @Argument(
        ...
        description = "The method for mapping generated names to original names (IR backend only)"
    )
    ...
    @Argument(value = "-meta-info", description = "Generates `.meta.js` and `.kjsm` files with metadata. Use for library creation.")
    var metaInfo = false
        set(value) {
            checkFrozen()
            field = value
    ...
    @Argument(value = "-target", valueDescription = "{ v5 }", description = "Generates JavaScript files for a specific ECMA version")
    ...
    @Argument(
            ...
            description = "The kind of JavaScript module generated by the compiler"
    )
    ...
    @Argument(
        ...
        description = "Defines whether the `main` function is called upon execution"
    )
    ...
    @Argument(
        value = "-Xes-classes",
        description = "Generates JavaScript that uses ES2015 classes."
    )
    ...
    @Argument(value = "-Xtyped-arrays", description = "Translates primitive arrays to JavaScript typed arrays")
    ...
    @Argument(value = "-Xfriend-modules-disabled", description = "Disables internal declaration export")
