// KT-60004: This test is copy-pasted from compiler/tests-spec/testData/diagnostics/notLinked/contracts/declarations/contractBuilder/common/neg/14.kt
// since contracts diagnostics fix needs to be checked with LightTree parser as well.
// There's no FirLightTreeDiagnosticTestSpecGenerated testrunner for initial test,
