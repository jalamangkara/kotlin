...
class BothFrontendsFacade(
    testServices: TestServices,
) : FrontendFacade<BothFrontendsOutputArtifact>(testServices, FrontendKinds.Both) {
    ...
    override fun analyze(module: TestModule): BothFrontendsOutputArtifact {
        ...
        return BothFrontendsOutputArtifact(k1Artifact, k2Artifact)
    }
