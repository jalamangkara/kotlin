...
import org.jetbrains.kotlin.test.backend.ir.IrBackendInputsFromBothFrontends
...
class Both2IrConverter(testServices: TestServices) :
    Frontend2BackendConverter<BothFrontendsOutputArtifact, IrBackendInputsFromBothFrontends>(
        testServices,
        FrontendKinds.Both,
    ...
    override fun transform(module: TestModule, inputArtifact: BothFrontendsOutputArtifact): IrBackendInputsFromBothFrontends? {
        ...
        return IrBackendInputsFromBothFrontends(irFromClassic, irFromFir)
    }
