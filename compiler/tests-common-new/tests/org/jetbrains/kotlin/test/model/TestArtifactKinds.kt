...
import org.jetbrains.kotlin.test.frontend.BothFrontendsOutputArtifact
...
object FrontendKinds {
    ...
    object Both : FrontendKind<BothFrontendsOutputArtifact>("Both")
...
object BackendKinds {
    ...
    object TwoIrBackends: BackendKind<IrBackendInputsFromBothFrontends>("TwoIrBackends")
...
object ArtifactKinds {
    ...
    object TwoJvm: BinaryKind<BinaryArtifacts.TwoJvm>("TwoJVM")
