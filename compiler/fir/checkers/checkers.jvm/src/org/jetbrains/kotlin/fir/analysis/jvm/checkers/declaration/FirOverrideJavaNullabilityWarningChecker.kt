            ...
            if (member is FirSimpleFunction) {
                val enhancedOverrides = scope
                    ...
                    .map {
                        ...
                        val substitutedBase = it.fir.substituteOrNull(substitutor, context.session) ?: return@map it
...
private fun FirSimpleFunction.substituteOrNull(
    ...
    val newReturnType = substitutor.substituteOrNull(returnTypeRef.coneType)?.also { isEnhanced = true }
