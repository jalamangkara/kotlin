...
object BackendDiagnosticRenderers {
    ...
    val EVALUATION_ERROR_EXPLANATION = Renderer<String> {
        ...
        when {
            ...
            exceptionName == "java.lang.StackOverflowError" -> "stack overflow (potentially due to infinite recursion)"
            exceptionName == "java.lang.NullPointerException" -> "null reference access"
