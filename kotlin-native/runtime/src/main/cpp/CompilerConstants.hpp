...
extern "C" const int32_t Kotlin_compileWithMarkBarriers;
...
ALWAYS_INLINE inline bool compileWithMarkBarriers() noexcept {
    return Kotlin_compileWithMarkBarriers != 0;
}
