...
public class IrBoxJsES6TestGenerated extends AbstractIrBoxJsES6Test {
    ...
    public class K2DifferencesChecks {
        ...
        public void testAllFilesPresentInK2DifferencesChecks() throws Exception {
            KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("js/js.translator/testData/box/k2DifferencesChecks"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.JS_IR_ES6, true);
        }
